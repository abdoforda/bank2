            ...
            <div class="content-body">
                <div>
                    <div class="row justify-content-between align-items-center pagination-bar bg-white"
                        style="padding: 20px 26px; border-top: 1px solid rgb(233, 236, 239);">
                            ...
                            <div class="row">
                                <div class="mb-1 col-sm-6 col-xl-4 col-12">
                                    <div class="d-flex flex-column align-items-center bg-white border rounded p-1">
                                        <h3 class="font-weight-bold"> USDT (TRC20) </h3>
                                        <div class="mb-1" style="height: 150px;"><img
                                                src="https://democaapi.zagzig.org/public/wallets/20230705_055000_1688536200_80793.png"
                                                height="150" width="100%" class="rounded"></div>
                        ...
                        <div class="text-center text-md-right col-md-2 col-12"><button type="button"
                                class="btn btn-primary">Add Wallet</button></div>
                    </div>
                    <!---->
                    <!---->
                    <!---->
