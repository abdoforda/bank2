...
@section('content')
    ...
    style="--img: url(/images/new_images/pages/risk_warnings.webp)">
        <div class="container">
            <div class="display-5 color2 fw-bold letter-s-4">
                @lang('Risk Warning for TradeLive AI Investment LLC')
            </div>
             <div class="row mt-4">
    ...
    <div class="bg-white pt-5 pb-5 cht03">
        ...
        <div class="container">
            ...
            <p class="leac">@lang('The trading platform used by TradeLive AI Investment LLC may be subject to technological vulnerabilities, including hacking or cyber-attacks. These risks can impact the security and integrity of client accounts and transactions.')</p>
            <br>
            ...
            <p class="leac">@lang('There may be risks that are beyond the control of TradeLive AI Investment LLC, such as acts of nature, political instability, or technological')</p>
            <br>
