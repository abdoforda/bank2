...
@section('content')
    ...
    <section class="bg-g">
        <div class="container text-center ">
            <h3>
                <strong>@lang('Benefits of using Fix API with Highness Investment LLC:')</strong>
                <br>
            </h3>
            ...
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col-md-7 padding-start-5-pc">
                    <p class="text-black-75">
                        @lang('Highness Investment LLC offers Fix API trading tool for its clients, which is a popular trading platform widely used by institutional traders and hedge funds. Fix API stands for Financial Information Exchange Application Programming Interface, and it provides direct access to liquidity providers and exchanges, enabling traders to execute trades quickly and efficiently.')
                    </p>
                    <h3>
                        <strong>@lang("Advantages of Highness Investment LLC's Fix API:")</strong>
                    </h3>
