...
@section('content')
    ...
    <div class="bg-white pt-5 pb-5">
        ...
        <div class="container">
            ...
            <p class="leac">@lang('At TradeLive AI, we use cookies to improve the functionality and performance of our website, as well as to provide personalized content and advertisements. By using our website, you consent to the use of cookies as outlined in this policy.')</p>
            <br>
