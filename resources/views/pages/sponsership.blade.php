...
@section('content')
    ...
    <section class="pt-5 pb-5"
        style="background-image: url(https://roboforex.com/uploads/pages/about/activity/sponsorship/images/new/kulebin-bg.webp);
        ...
        <div class="container ">
            <div class="row justify-content-center align-items-center g-2">
                <div class="col-md-6">
                    ...
                    <p class="small">@lang('RoboForex Ltd is the official sponsor of a successful Belarusian Muay Thai fighter and coach Andrei Kulebin. Kulebin has more than 200 wins; he is a many-time Thai boxing world champion and an Honored Master of Sports of Belarus.')</p>
