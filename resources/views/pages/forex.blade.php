...
@section('content')
    <div class="i-f-w min-vh-50 d-flex align-items-center" style="--img: url(/images/new_images/pages/forex.webp)">
        <div class="container">
            ...
            <div class="display-5 color2 fw-bold mt-4">@lang('Trade Forex CFDs Online')</div>
            <div class="row mt-4">
                <div class="col-md-9 text-white desc_page">
                    <p>@lang('We provide more than 100 forex pairs to utilize the opportunities of the biggest financial market in the world.')</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section>
        ...
        <div class="container mt-4">
            ...
            <div class="ask_div p-3 mt-2">
                <a class="ask_click" data-bs-toggle="collapse" href="#tab01" role="button" aria-expanded="false"
                    aria-controls="tab01">
                    What is Forex trading, and how can I get started?
                </a>

                <div class="collapse multi-collapse" id="tab01">
                    <div class="p-3">
                        <p>Forex trading involves buying and selling different currencies from around the world, in order to
                            gain profits from changes in their exchange rates. To get started with Forex trading, you will
                            have to open a trading account with a reputable broker, to deposit funds, and then start placing
                            trades.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="ask_div ask_div2 p-3 mt-2">
                <a class="ask_click" data-bs-toggle="collapse" href="#tab02" role="button" aria-expanded="false"
                    aria-controls="tab02">
                    What are the risks of Forex trading?
                </a>
                <div class="collapse multi-collapse" id="tab02">
                    <div class="p-3">
                        <div class="panel-body gray">
                            <p>Forex trading can be highly risky, as it involves trading on leverage, which means you can
                                potentially lose more than your initial investment. Further, Forex market is highly volatile
                                and can be affected by various factors, such as economic indices, political events, and
                                global news.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="ask_div p-3 mt-2">
                <a class="ask_click" data-bs-toggle="collapse" href="#tab03" role="button" aria-expanded="false"
                    aria-controls="tab03">
                    What strategies can I use for Forex trading?
                </a>

                <div class="collapse multi-collapse" id="tab03">
                    <div class="p-3">
                        <p>There are various strategies that traders use for Forex trading, such as technical analysis,
                            fundamental analysis, and price action trading. Each strategy has its own pros and cons, and it
                            is important to choose a strategy that fits your trading tactics and your risk tolerance.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="ask_div ask_div2 p-3 mt-2">
                <a class="ask_click" data-bs-toggle="collapse" href="#tab04" role="button" aria-expanded="false"
                    aria-controls="tab04">
                    What is a pip, and how is it calculated?
                </a>
                <div class="collapse multi-collapse" id="tab04">
                    <div class="p-3">
                        <div class="panel-body gray">
                            <p>A pip is the smallest unit of measurement in Forex trading, and it stands for "percentage in
                                point." It represents the fourth decimal place in currency pairs, except for the Japanese
                                yen, where it represents the second decimal place. Pip values can be calculated using the
                                formula: pip value = (1 pip / exchange rate) * position size.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ask_div p-3 mt-2">
                <a class="ask_click" data-bs-toggle="collapse" href="#tab05" role="button" aria-expanded="false"
                    aria-controls="tab05">
                    What are the best times to trade in Forex?
                </a>

                <div class="collapse multi-collapse" id="tab05">
                    <div class="p-3">
                        <p>The Forex market is open 24 hours a day, five days a week, which means you can trade at any time.
                            However, certain times of the day are considered to be more favorable for trading, such as when
                            there is a high market volatility and liquidity. The most active trading sessions are the
                            London, New York, and Tokyo sessions, and traders often look for trading opportunities during
                            these times.</p>
                    </div>
                </div>
            </div>
