...
@section('content')
    <div class="i-f-w min-vh-50 d-flex align-items-center"
        style="--img: url(/images/new_images/pages/tradelive_media.webp)">
        <div class="container">
            <div class="display-5 color2 fw-bold letter-s-4">
                @lang('TradeLive AI  Media')
            </div>
            <div class="row mt-4">
    ...
    <section>
        ...
        background-size: cover; border-radius: 16px;">
            <div class="row justify-content-center align-items-center g-2">
                <div class="col-lg-4 col-md-8 col-12 text-white">
                    <h3 class="h2">
                ...
                <div class="col-md-8 position-relative d-none d-md-block">
                    <img src="/images/new_images/sections/d-1.webp"
        ...
        <div>
            <div class="container">
                <div class="row justify-content-center align-items-center gy-0 gx-3 news-box">
                    ...
                    <div class="col-12 pb-3 pagination">
                        {{ $news->links() }}
                    </div>
