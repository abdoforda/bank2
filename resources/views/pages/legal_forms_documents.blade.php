...
@section('content')
    <div class="i-f-w min-vh-50 d-flex align-items-center"
        ...
        <div class="container">
            ...
            <div class="col-md-9 text-white desc_page">
                <p>@lang('TradeLive AI Investment LLC provides a range of legal forms and documents to facilitate various business activities and ensure compliance with regulatory requirements. These documents are designed to protect the rights and interests of all parties involved. Some of the key legal forms and documents offered by TradeLive AI Investment LLC include')</p>
            </div>
        </div>
        </div>
    </div>
    ...
    <section>
        <div class="container">
            <h3>
                @lang('TradeLive AI Investment LLC Agreement')
            </h3>
            <div class="mt-4 row justify-content-center g-2">
                <div class="col-md-6">
                    <div class="row justify-content-center align-items-center g-2">
                        ...
                        <div class="col-10">
                            <a download href="{{ asset('storage/files/Trading Agreement 2.pdf') }}" download="TradeLive AI Investment LLC Agreement.pdf">
                                <h4 class="h6 color2">@lang('TradeLive AI Investment LLC Agreement')</h4>
                            </a>
                            <p class="small">@lang('As a partner or client of TradeLive AI Investment LLC, it is essential to review and accept the terms and conditions outlined in the agreement before conducting any business activities.')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row justify-content-center align-items-center g-2">
                        ...
                        <div class="col-10">
                            ...
                            <p class="small">@lang('TradeLive AI Investment LLC adheres to strict guidelines and regulations to prevent any involvement in illegal financial activities. These measures are in place to ensure the integrity and legality of all transactions.')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row justify-content-center align-items-center g-2">
                        ...
                        <div class="col-10">
                            ...
                            <p class="small">@lang('For corporate clients, TradeLive AI Investment LLC follows a Know Your Customer (KYC) process to verify the identity and legitimacy of the corporate entity. This process ensures compliance with regulatory requirements and helps maintain the security and transparency of financial transactions.')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row justify-content-center align-items-center g-2">
                        ...
                        <div class="col-10">
                            ...
                            <p class="small">@lang('Trading and investing in financial markets involve inherent risks. It is important to understand and acknowledge these risks before engaging in any trading activities with TradeLive AI Investment LLC. The risk warning provides detailed information about the potential risks involved.')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row justify-content-center align-items-center g-2">
                        ...
                        <div class="col-10">
                            ...
                            <p class="small">@lang('TradeLive AI Investment LLC is committed to protecting the privacy and confidentiality of personal information provided by clients and partners. The privacy policy outlines how personal information is collected, used, and protected in accordance with applicable privacy laws.')</p>
                        </div>
                    </div>
                </div>
