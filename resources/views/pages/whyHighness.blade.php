    ...
    <div class="i-f-w min-vh-50 d-flex align-items-center" style="--img: url(/images/new_images/pages/why.webp)">
        <div class="container">
            <div class="display-5 color2 fw-bold letter-s-4">
                @lang('Why Highness Investment LLC?')
            </div>
             <div class="row mt-4">
            <div class="col-md-9 text-white desc_page">
                <p>@lang('Welcome to Highness Investment LLC , We are dedicated to providing you with the best possible trading experience and helping you achieve your financial goals. Here are just a few reasons why you should choose us:')</p>
            </div>
        </div>
        </div>
    </div>
    ...
    <section>
        <div class="container">
            <div class="row justify-content-center align-items-center g-4">
                <div class="col-md-12">
                    <h1 class="fw-light color">@lang('Why should you trade with  Highness Investment LLC?')</h1>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col-md-6 ps-5">
                    <h1 class="fw-light color">@lang('Why Highness different from others?')</h1>
...
.list-container ul li a:before{background:url(https://highnessinv.com/images/new_images/icons/Blue_Arrow_Right.webp) 50% / cover no-repeat;content:"";height:14px;left:-26px;position:absolute;top:8px;transition:all 0.15s ease-in-out;width:14px;}
