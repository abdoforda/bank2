    ...
    <div class="i-f-w min-vh-50 d-flex align-items-center"
        ...
        <div class="container">
            ...
            <div class="col-md-9 text-white desc_page">
                <p>@lang("At Highness Investment LLC, we prioritize the safety of our clients' funds. We utilize state-of-the-art security measures and work with reputable financial institutions to ensure that your investments are protected. Your peace of mind is our top priority.")</p>
            </div>
        </div>
        </div>
    </div>
    ...
    <section class="text-center">
        <div class="container">
            <div>
                ...
                <p class="mt-4 fs-5">@lang('Highness Investment LLC provides standard tools to help you do this')</p>
            </div>
