...
@section('content')
    ...
    <section>
        <div class="container">
            <div class="mb-5">
                <h4 class="h1">@lang('Diligence at Highness Investment LLC:') </h4>
                <p class="lead-in margin-bottom-40">@lang('Many of Highness Investment LLC  employees are working with the firm for at least half of its 14-year history and they are committed to the major principles of Highness Investment LLC.')</p>
            </div>
            <div class="row  g-3">
                <div class="col-md-6">
                    ...
                    <p class="mt-3 lead fs-6">
                        @lang('Highness Investment LLC is committed to the professional development and the improvement of its employees. The company provides training, guidance, and career enhancement to help its staff build prominent careers in  trading industry.')
                    </p>
                </div>
                <div class="col-md-6">
                    ...
                    <p class="mt-3 lead fs-6">@lang('Highness Investment LLC places strong emphasis on providing exceptional services to its clients. The company strives to meet and exceed their expectations by offering customized solutions and technical')</p>
                </div>
            </div>
        </div>
    </section>
