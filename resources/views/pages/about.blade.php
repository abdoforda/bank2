...
@section('content')
    <div class="i-f-w min-vh-50 d-flex align-items-center" style="--img: url(/images/new_images/pages/about.webp)">
        <div class="container">
            <div class="display-5 color2 fw-bold">@lang('Welcome to Highness Investment LLC')</div>
            <div class="row mt-4">
            ...
            <div class="col-md-12 text-align-c768 m-b-20">
                ...
                <div class="row justify-content-center align-items-center g-2">
                    ...
                    <div class="col-md-5 col-md-offset-1 col-sm-6 col-xs-12 text-align-c768 gray-box rounded small">
                        ...
                        <p style="line-height: 30px;">@lang('The experienced and dynamic management team at Highness Investment LLC, sharpened by years of effective trading across various platforms and markets, faced a growing challenges through the traditional web-based Forex brokers, including the delay of performing trading, system failures, and poor customer services. In response, Highness seeks to forge a path forward with cutting-edge technology, innovative systems solutions, competitive commission rates, and unparalleled customer support.')</p>
                    </div>
                </div>
            </div>
        </div>
