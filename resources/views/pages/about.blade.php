...
@section('content')
    <div class="i-f-w min-vh-50 d-flex align-items-center" style="--img: url(/images/new_images/pages/about.webp)">
        <div class="container">
            <div class="display-5 color2 fw-bold">@lang('Welcome to TradeLive AI Investment LLC')</div>
            <div class="row mt-4">
