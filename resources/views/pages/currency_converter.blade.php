            ...
            <div class="row align-items-center g-2">
                <div class="col-md-8">
                    ...
                    <div class="mt-5">
                        ...
                        <h4 itemprop="name">@lang('How to use the TradeLive AI  Currency Converter?')</h4>
                            <div itemprop="text">
                                <p>@lang('Using the TradeLive AI  Currency Converter is simple and straightforward. Follow these steps to make accurate currency conversions:')</p>
                                <ol>

                                    <li>@lang('Visit the TradeLive AI  website or access the Currency Converter tool through our trading platform.') </li>
                                    ...
                                    <li>@lang('Take advantage of the accurate and up-to-date exchange rates provided by TradeLive AI  to make informed trading decisions.') </li>
