...
@section('content')
    ...
    <section>
        <div class="container">
            <h3 class="mb-3">
                @lang('How to Uninstall TradeLive AIfor PC ?')
            </h3>
    ...
    @include(
        ...
        [
            ...
            'items' => [
                [
                    'title' => __('How do I access the TradeLive AIplatform for trading with TradeLive AI?'),
                    'bode' =>
                        __('To start trading on the TradeLive AIplatform with TradeLive AI, you have to open a TradeLive AItrading account. You can not trade on the TradeLive AIplatform using your existing MT4 account. To open an TradeLive AIaccount, simply click on the provided link.'),
                ],[
                    'title' => __('Can I use the ID of my MT4 account to access TradeLive AIaccount with TradeLive AI?'),
                    'bode' =>
                        __('No, you can’t. You need to have a separate TradeLive AItrading account. To open an TradeLive AIaccount, click on the provided link.'),
                ],[
                    'title' => __('How can I verify my TradeLive AIaccount with TradeLive AI?'),
                    'bode' =>
                        __('If you are an existing client with TradeLive AI using a MT4 account, you may open additional TradeLive AIaccount from the dashboard of your account without a need to re-submit your verification documents. However, if you are a new client, you will need to provide all the required verification documents, including proof of identity and proof of residency.'),
                ],[
                    'title' => __('Can I trade on stock CFDs using my existing MT4 trading account at TradeLive AI?'),
                    'bode' =>
                        __("No, you can't. You need to have an TradeLive AItrading account to trade in stock CFDs with TradeLive AI. To open TradeLive AIaccount, click on the provided link."),
                ],[
                    'title' => __('What are the types of instruments used for trading on TradeLive AIat TradeLive AI?'),
                    'bode' =>
                        __('You may trade in all instruments used at TradeLive AI on the TradeLive AIplatform, including stock CFDs, stock indices CFDs, Forex, CFDs on cryptocurrencies, CFDs on precious metals, and CFDs on energies.'),
                ],
            ],
        ]
    )
