            ...
            <div class="row justify-content-center align-items-center g-4">
                <div class="col-md-6">
                    <div >
                        ...
                        <p class="mt-4 text-white-50">@lang('If you have any questions or enquiries, fill in the form in this section. Alternatively, contact us at partners@Highness.ae and one of our Account Managers will get back to you soon.')</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div >
