        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col-md-7 padding-start-5-pc">
                    <p class="text-black-75">@lang('Highness Investment LLC offers an automated Expert Advisor (EA) trading tool for clients, allowing for efficient and reliable trading with customizable parameters. The EA tool integrates with MetaTrader, handles high volumes of trades, and provides real-time monitoring, reporting, and analysis. Dedicated support is also provided for users.')</p>
                    <h3>
                        <strong>@lang("Advantages of Highness Investment LLC's Expert Advisor:")</strong>
                    </h3>
                    <div class="list-container">
                        <ul>
                          ...
                          <li><a class="small text-black-50">@lang('Dedicated support from Highness Investment LLC') </a></li>
        ...
        <div class="container">
            <div class="row justify-content-center g-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="small">
                        @lang("Highness Investment LLC's Expert Advisor (EA) account brokers allow clients to automate their trading strategies through a single Master Account. Our EA technology ensures efficient and reliable management, with customizable parameters for risk management and lot sizes. Clients benefit from automated trading with maximum convenience and control.") 
                    </p>
                </div>
