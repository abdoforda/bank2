...
@section('content')
    ...
    <section class="bg-g">
        <div class="container text-center ">
            <h3>
                <strong>@lang('Benefits of using Expert Advisor with TradeLive AI Investment LLC:')</strong>
                <br>
            </h3>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col-md-7 padding-start-5-pc">
                    <p class="text-black-75">@lang('TradeLive AI Investment LLC offers an automated Expert Advisor (EA) trading tool for clients, allowing for efficient and reliable trading with customizable parameters. The EA tool integrates with MetaTrader, handles high volumes of trades, and provides real-time monitoring, reporting, and analysis. Dedicated support is also provided for users.')</p>
                    <h3>
                        <strong>@lang("Advantages of TradeLive AI Investment LLC's Expert Advisor:")</strong>
                    </h3>
                    <div class="list-container">
                        <ul>
                          ...
                          <li><a class="small text-black-50">@lang('Dedicated support from TradeLive AI Investment LLC') </a></li>
        ...
        <div class="container">
            <div class="row justify-content-center g-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="small">
                        @lang("TradeLive AI Investment LLC's Expert Advisor (EA) account brokers allow clients to automate their trading strategies through a single Master Account. Our EA technology ensures efficient and reliable management, with customizable parameters for risk management and lot sizes. Clients benefit from automated trading with maximum convenience and control.") 
                    </p>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <p class="small">
                        @lang("An Expert Advisor (EA) is an automated trading system that executes trades based on pre-programmed trading strategies. EAs operate within the MetaTrader client end application, allowing for seamless integration with TradeLive AI Investment LLC's trading platform. Clients can monitor and adjust their EAs in real-time, with access to market data and price feeds for accurate decision-making.") 
                    </p>
                </div>
