...
document.addEventListener('DOMContentLoaded', () => {
    ...
    сyrillicInputBan(signupIndividualPhoneNumberInputElem);
    сyrillicInputBan(signupCorporatePhoneNumberInputElem);
    сyrillicInputBan(depositMttransactionsPlusPhoneInputElem);
